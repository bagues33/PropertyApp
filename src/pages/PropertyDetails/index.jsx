          ...
          <div className="flex flex-col gap-10 items-start justify-start w-full">
              ...
              <div className="flex md:flex-col flex-row gap-6 items-center justify-center max-w-[1200px] mx-auto w-full">
                ...
                <div className="flex sm:flex-1 flex-col gap-6 h-[550px] md:h-auto items-start justify-start w-auto sm:w-full">
                  ...
                  <div className="h-[263px] relative w-96 sm:w-full">
                    ...
                    />
                    <Button
                      className="bg-white_A700 bottom-[0] cursor-pointer flex items-center justify-center min-w-[122px] px-4 py-2.5 right-[0] rounded-[10px]"
                      leftIcon={
                        <Img
            ...
            <div className="flex flex-col font-manrope items-center justify-center md:px-10 sm:px-5 px-[120px] w-full">
              <div className="flex md:flex-col flex-row gap-6 items-start justify-center max-w-[1200px] mx-auto w-full">
                    ...
                    <div className="flex flex-col gap-11 items-start justify-start w-full">
                      <div className="flex flex-col gap-6 items-start justify-start w-full">
                        <div className="flex flex-col gap-4 items-start justify-start w-full">
                          <Text
                            className="leading-[135.00%] max-w-[712px] md:max-w-full text-gray_900 tracking-[-0.56px]"
                            as="h4"
                            variant="h4"
                          >
                        ...
                        <div className="flex sm:flex-col flex-row gap-4 items-start justify-start md:pr-10 sm:pr-5 pr-[180px] w-full">
                          <div className="bg-white_A700 border border-gray_600 border-solid flex flex-1 flex-col items-center justify-center sm:px-5 px-6 py-[7px] rounded-[10px] w-full">
                            <div className="flex flex-col gap-1 items-start justify-start w-full">
                              ...
                              <Text
                                className="text-gray_600 w-full"
                                variant="body7"
                              >
                                Online / Cash Payment
                              </Text>
                      ...
                      <div className="flex flex-col gap-4 items-start justify-start w-full">
                        ...
                        <Text
                          className="font-normal leading-[180.00%] max-w-[712px] md:max-w-full text-gray_600"
                          variant="body3"
                        >
                        ...
                        <div className="flex flex-1 flex-col gap-2.5 items-start justify-start w-full">
                          <div className="flex flex-row gap-[55px] items-start justify-start w-full">
                            <div className="flex flex-1 flex-row gap-2.5 items-center justify-start w-full">
                              ...
                              <Text
                                className="flex-1 font-normal text-gray_600 w-auto"
                                variant="body3"
                              >
                                Parking
                              </Text>
                    ...
                    <div className="flex flex-col gap-[26px] items-start justify-start w-full">
                      ...
                      <div className="flex flex-row gap-6 items-center justify-start w-full">
                        ...
                        <div className="flex flex-col gap-[3px] items-start justify-start w-auto">
                          <Text
                            className="font-semibold text-gray_900 tracking-[-0.40px] w-auto"
                            variant="body1"
                          >
                            Bruno Fernandes
                          </Text>
                ...
                <div className="bg-white_A700 border border-bluegray_100 border-solid flex sm:flex-1 flex-col items-start justify-start p-6 sm:px-5 rounded-[10px] w-auto sm:w-full">
          ...
          <div className="flex flex-col font-manrope items-center justify-center md:px-10 sm:px-5 px-[120px] w-full">
            <div className="flex flex-col gap-10 items-center justify-center max-w-[1200px] mx-auto w-full">
              <div className="flex sm:flex-col flex-row gap-5 items-center justify-start w-full">
                <Text
                  className="flex-1 text-gray_900 tracking-[-0.56px] w-auto"
                  as="h4"
                  variant="h4"
                >
