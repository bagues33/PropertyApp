    ...
    <>
      <div className="bg-gray_51 flex flex-col font-markoone sm:gap-10 md:gap-10 gap-[100px] items-start justify-start mx-auto w-auto sm:w-full md:w-full">
        <div className="flex flex-col md:gap-10 gap-[60px] items-start justify-start w-full">
          <Header className="bg-white_A700 flex gap-2 h-20 md:h-auto items-center justify-between md:px-5 px-[120px] py-[19px] w-full" />
            ...
            <div className="flex flex-col md:gap-10 gap-[60px] items-start justify-start w-full">
              ...
              <div className="flex flex-col gap-10 items-start justify-start w-full">
                ...
                <div className="flex flex-col gap-6 items-start justify-start w-full">
                  ...
                  <Text
                    className="font-normal leading-[180.00%] max-w-[1054px] md:max-w-full text-gray_600"
                    variant="body3"
                  >
