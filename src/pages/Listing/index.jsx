...
const ListingPage = () => {
  ...
  return (
    <>
      <div className="bg-gray_51 flex flex-col font-markoone sm:gap-10 md:gap-10 gap-[100px] items-start justify-start mx-auto w-auto sm:w-full md:w-full">
        <div className="flex flex-col md:gap-10 gap-[60px] items-center justify-center w-full">
          ...
          <div className="flex flex-col font-manrope items-center justify-start md:px-10 sm:px-5 px-[120px] w-full">
            <div className="flex flex-col gap-6 items-center justify-center max-w-[1200px] mx-auto w-full">
              <Text
                className="text-gray_900 tracking-[-0.72px] w-full"
                as="h3"
                variant="h3"
              >
                Find Property
              ...
              <div className="flex flex-col gap-3 items-start justify-start w-full">
                <div className="flex md:flex-col flex-row gap-5 items-start justify-start w-full">
                  <div className="bg-white_A700 border border-bluegray_100 border-solid flex flex-1 flex-col h-[60px] md:h-auto items-start justify-start px-4 py-3.5 rounded-[10px] w-full">
                    <Input
                      ...
                      className="font-semibold p-0 placeholder:text-gray_700 text-gray_700 text-left text-lg w-full"
                  ...
                  />
                  <Button
                    className="bg-white_A700 border border-bluegray_100 border-solid cursor-pointer flex items-center justify-center min-w-[113px] px-4 py-[18px] rounded-[10px]"
                    rightIcon={
                      <Img
                  ...
                  <Button
                    className="bg-gray_900 cursor-pointer flex items-center justify-center min-w-[124px] px-4 py-5 rounded-[10px]"
                    rightIcon={
                      <Img
                ...
                <div className="flex flex-row flex-wrap gap-2.5 items-start justify-start max-w-[1200px] w-full">
                  ...
                  <Button
                    className="border border-bluegray_101 border-solid cursor-pointer flex items-center justify-center min-w-[243px] px-3.5 py-[7px] rounded-[10px]"
                    rightIcon={
                      <Img
                        src="images/img_close.svg"
                  ...
                  <Button
                    className="border border-bluegray_101 border-solid cursor-pointer flex items-center justify-center min-w-[151px] px-3.5 py-[7px] rounded-[10px]"
                    rightIcon={
                      <Img
                        src="images/img_close.svg"
                        className="mt-0.5 mb-px ml-2"
                  ...
                  <Button
                    className="border border-bluegray_101 border-solid cursor-pointer flex items-center justify-center min-w-[168px] px-3.5 py-[7px] rounded-[10px]"
                    rightIcon={
                      <Img
                        src="images/img_close.svg"
                        className="mt-px mb-[3px] ml-2"
                  ...
                  <Button
                    className="border border-bluegray_101 border-solid cursor-pointer flex items-center justify-center min-w-[174px] px-3.5 py-[7px] rounded-[10px]"
                    rightIcon={
                      <Img
                        src="images/img_close.svg"
                        className="mt-0.5 mb-px ml-2"
          ...
          <div className="flex flex-col font-manrope items-center justify-center md:px-10 sm:px-5 px-[120px] w-full">
            <div className="flex md:flex-col flex-row gap-6 items-start justify-center max-w-[1200px] mx-auto w-full">
              <div className="h-[511px] relative w-[32%] md:w-full">
                ...
                <div className="absolute bg-white_A700 border border-gray_600 border-solid flex flex-col h-max inset-y-[0] items-center justify-start left-[7%] my-auto px-4 py-6 rounded-lg w-[308px]">
                  <div className="flex flex-col gap-[21.66px] items-start justify-start w-full">
                    <div className="flex flex-row gap-[9.63px] items-center justify-start w-full">
                      ...
                      />
                      <Text
                        className="flex-1 text-gray_900 w-auto"
                        variant="body6"
                      >
                    ...
                    >
                      <div className="flex flex-1 flex-row gap-[32.08px] items-center justify-between my-0 w-full">
                        <div className="flex flex-1 flex-row gap-[9.63px] items-center justify-start w-full">
                          ...
                          />
                          <Text
                            className="flex-1 text-gray_700 w-auto"
                            variant="body6"
                          >
                            3 Bed Room
                          </Text>
                        ...
                        <div className="flex flex-1 flex-row gap-[9.63px] items-center justify-start w-full">
                          ...
                          />
                          <Text
                            className="text-gray_700 w-auto"
                            variant="body6"
                          >
                            1 Bath
                          </Text>
                    ...
                    <div className="flex flex-col items-center justify-start w-full">
                      <Text
                        className="text-gray_900 tracking-[-0.39px] w-auto"
                        variant="body2"
                      >
                        $649,900
                      </Text>
              ...
              <div className="flex flex-1 flex-col md:gap-10 gap-[60px] items-start justify-start w-full">
                ...
                <div className="flex sm:flex-col flex-row gap-5 items-center justify-between w-full">
                  ...
                  <Button
                    className="border border-bluegray_102 border-solid cursor-pointer flex items-center justify-center min-w-[134px] px-[18px] py-4 rounded-[10px]"
                    rightIcon={
                      <Img
