...
const LandingPagePage = () => {
  ...
  return (
    <>
      <div className="bg-white_A700 flex flex-col font-markoone sm:gap-10 md:gap-10 gap-[100px] items-center justify-start mx-auto w-auto sm:w-full md:w-full">
        <div className="flex flex-col items-start justify-start w-full">
          <LandingPageHeader className="bg-white_A700 flex gap-2 h-20 md:h-auto items-center justify-between md:px-5 px-[120px] py-[19px] w-full" />
            ...
            <div className="flex md:flex-col flex-row md:gap-10 gap-[100px] items-center justify-start w-full">
              <div className="flex flex-1 flex-col gap-10 items-start justify-start w-full">
                <div className="flex flex-col gap-4 items-start justify-start w-full">
                  <Text
                    className="leading-[140.00%] text-gray_900 tracking-[-0.92px]"
                    as="h2"
                    variant="h2"
                  >
                    <>
                  ...
                  <Text
                    className="font-normal leading-[180.00%] max-w-[610px] md:max-w-full text-gray_700"
                    variant="body1"
                  >
          ...
          <div className="flex md:flex-col flex-row gap-6 items-center justify-center max-w-[1200px] mx-auto w-full">
            <div className="bg-red_100 flex flex-1 flex-col h-[424px] md:h-auto items-start justify-center md:px-10 sm:px-5 px-[50px] py-[46px] rounded-[20px] w-full">
              <div className="flex flex-col gap-[50px] items-start justify-start w-full">
                <div className="flex flex-col gap-4 items-start justify-start w-full">
                  <Text
                    className="leading-[140.00%] max-w-[488px] md:max-w-full text-gray_900 tracking-[-0.72px]"
                    as="h3"
                    variant="h3"
                  >
                  ...
                  <Text
                    className="font-normal leading-[180.00%] max-w-[488px] md:max-w-full text-gray_900"
                    variant="body3"
                  >
                ...
                <Button className="bg-gray_900 cursor-pointer font-semibold min-w-[138px] sm:px-5 px-6 py-4 rounded-[10px] text-base text-center text-white_A700">
                  Get Started
                </Button>
              </div>
            </div>
              ...
              <div className="sm:gap-5 gap-6 grid sm:grid-cols-1 grid-cols-2 justify-center min-h-[auto] w-full">
                <div className="bg-deep_orange_50 flex flex-1 flex-col h-[200px] md:h-auto items-start justify-center sm:px-5 px-[30px] py-6 rounded-[20px] w-full">
                  <div className="flex flex-col gap-5 items-start justify-start w-full">
                    ...
                    />
                    <Text
                      className="leading-[135.00%] max-w-[222px] md:max-w-full text-gray_900 tracking-[-0.56px]"
                      as="h4"
                      variant="h4"
                    >
          ...
          <div className="flex md:flex-col flex-row md:gap-10 gap-[100px] items-start justify-start max-w-[1200px] mx-auto w-full">
            ...
            >
              <div className="flex flex-col gap-[18px] items-start justify-start w-full">
                ...
                <div className="flex flex-col gap-3.5 items-start justify-start w-full">
                  <Text
                    className="text-gray_900 tracking-[-0.92px] w-full"
                    as="h2"
                    variant="h2"
                  >
                    $15.4M
                  ...
                  <Text
                    className="font-semibold leading-[140.00%] text-bluegray_600 tracking-[-0.40px]"
                    variant="body1"
                  >
                    <>
                      Owned from
              ...
              <div className="flex flex-col gap-[18px] items-start justify-start w-full">
                ...
                <div className="flex flex-col gap-3.5 items-start justify-start w-full">
                  ...
                  <Text
                    className="font-semibold leading-[140.00%] max-w-[225px] md:max-w-full text-bluegray_600 tracking-[-0.40px]"
                    variant="body1"
                  >
            ...
            <div className="flex flex-1 flex-col gap-[18px] items-start justify-start w-full">
              ...
              <div className="flex flex-col gap-3.5 items-start justify-start w-full">
                ...
                <Text
                  className="font-semibold text-bluegray_600 tracking-[-0.40px] w-full"
                  variant="body1"
                >
                  Reagular Clients
                </Text>
          ...
          <div className="flex flex-col md:gap-10 gap-[60px] md:h-auto items-start justify-start max-w-[1200px] mx-auto w-full">
            <div className="flex flex-col gap-6 items-start justify-start w-full">
              <div className="flex sm:flex-col flex-row md:gap-10 items-center justify-between w-full">
                <Text
                  className="text-gray_900 tracking-[-0.72px] w-auto"
                  as="h3"
                  variant="h3"
                >
                  Featured Properties
              ...
              <div className="flex sm:flex-col flex-row gap-2.5 items-start justify-start w-full">
                <Button className="bg-transparent cursor-pointer font-bold min-w-[159px] text-center text-gray_900 text-lg">
                  Resident Property
                </Button>
                <Button className="bg-transparent cursor-pointer font-bold min-w-[186px] text-center text-gray_400 text-lg">
                  Commercial Property
                </Button>
                <Button className="bg-transparent cursor-pointer font-bold min-w-[164px] text-center text-gray_400 text-lg">
                  Industrial Property
                </Button>
                <Button className="bg-transparent cursor-pointer font-bold min-w-[180px] text-center text-gray_400 text-lg">
          ...
          <div className="flex flex-col md:gap-10 gap-[150px] items-center justify-center max-w-[1200px] mx-auto w-full">
            <div className="flex md:flex-col flex-row md:gap-10 gap-[85px] items-center justify-start w-full">
              <div className="flex flex-1 flex-col md:gap-10 gap-[60px] items-start justify-start w-full">
                <div className="flex flex-col gap-5 items-start justify-start w-full">
                  <Text
                    className="leading-[140.00%] max-w-[557px] md:max-w-full text-gray_900 tracking-[-0.72px]"
                    as="h3"
                    variant="h3"
                  >
                    Simple & easy way to find your dream Appointment
                  ...
                  <Text
                    className="font-normal leading-[180.00%] max-w-[557px] md:max-w-full text-gray_700"
                    variant="body3"
                  >
                    Lorem Ipsum is simply dummy text of the printing and
            ...
            <div className="flex md:flex-col flex-row md:gap-10 gap-[157px] items-center justify-start w-full">
              ...
              <div className="flex flex-1 flex-col md:gap-10 gap-[60px] items-start justify-start w-full">
                <div className="flex flex-col gap-5 items-start justify-start w-full">
                  <div className="flex flex-col gap-5 items-start justify-start w-full">
                    <Text
                      className="leading-[140.00%] max-w-[521px] md:max-w-full text-gray_900 tracking-[-0.72px]"
                      as="h3"
                      variant="h3"
                    >
                    ...
                    <Text
                      className="font-normal leading-[180.00%] max-w-[521px] md:max-w-full text-gray_700"
                      variant="body3"
                    >
                      Lorem Ipsum is simply dummy text of the printing and
                      typesetting industry. In a free hour, when our power of
                ...
                <Button className="bg-gray_900 cursor-pointer font-semibold min-w-[134px] py-[13px] rounded-[10px] text-base text-center text-white_A700">
                  Learn more
                </Button>
              </div>
            </div>
                      ...
                      <div className="flex flex-col gap-[30px] items-start justify-start w-full">
                        <div className="flex sm:flex-col flex-row sm:gap-10 gap-[73px] items-center justify-start w-full">
                          <div className="flex flex-1 flex-col gap-1 items-start justify-start w-full">
                            <Text
                              className="text-gray_900 tracking-[-0.56px] w-full"
                              as="h4"
                              variant="h4"
                            >
                              Taylor Wilson
                            ...
                            <Text
                              className="font-semibold text-gray_900 w-full"
                              variant="body3"
                            >
                        ...
                        <Text
                          className="font-semibold leading-[165.00%] max-w-[455px] md:max-w-full text-gray_700"
                          as="h5"
                          variant="h5"
                        >
          ...
          <div className="flex flex-row gap-[30px] items-start justify-between pl-[770px] pr-[215px] md:px-10 sm:px-5 w-full">
            <div className="flex flex-row gap-2 items-center justify-start w-auto">
              <Img
                ...
                alt="arrowleft"
              />
              <Text className="font-bold text-gray_604 w-auto" variant="body3">
                Previews
              </Text>
            </div>
            <div className="flex flex-row gap-2 items-center justify-start w-auto">
          ...
          <div className="flex flex-col md:gap-10 gap-[120px] items-center justify-start max-w-[1200px] mx-auto w-full">
            <div className="flex flex-col md:gap-10 gap-[60px] items-start justify-start w-full">
              <div className="flex sm:flex-col flex-row gap-5 items-center justify-start w-full">
                <Text
                  className="flex-1 text-white_A700 tracking-[-0.72px] w-auto"
                  as="h3"
                  variant="h3"
                >
                  News & Consult
              ...
              >
                <div className="flex flex-1 flex-col gap-6 h-[487px] md:h-auto items-start justify-start w-full">
                  ...
                  <div className="flex flex-col gap-6 items-start justify-start w-full">
                    <Text
                      className="font-bold leading-[135.00%] md:max-w-full max-w-sm text-white_A700 tracking-[-0.48px]"
                      as="h5"
                      variant="h5"
                    >
            ...
            <div className="bg-gray_401 flex flex-col items-center justify-center md:px-10 sm:px-5 px-[100px] py-10 rounded-[10px] w-full">
              <div className="flex flex-col gap-[30px] items-center justify-start md:px-10 sm:px-5 px-[200px] w-full">
                <div className="flex flex-col gap-2.5 items-center justify-start w-full">
                  <Text
                    className="text-center text-gray_900 tracking-[-0.56px] w-full"
                    as="h4"
                    variant="h4"
                  >
                  ...
                  <Text
                    className="font-normal leading-[180.00%] max-w-[600px] md:max-w-full text-center text-gray_900"
                    variant="body3"
                  >
                    We helps businesses customize, automate and scale up their
                    ad production and delivery.
                ...
                <div className="flex sm:flex-col flex-row gap-2 items-start justify-start w-full">
                  ...
                  ></Input>
                  <Button className="bg-gray_900 cursor-pointer font-semibold min-w-[126px] sm:px-5 px-6 py-4 rounded-[10px] text-base text-center text-white_A700">
                    Subscribe
                  </Button>
                </div>
              </div>
        ...
        <LandingPageFooter className="bg-white_A700 flex gap-2 items-center justify-center md:px-5 px-[120px] py-20 w-full" />
      </div>
    </>
  );
};
