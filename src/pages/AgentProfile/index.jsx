...
const AgentProfilePage = () => {
  ...
  return (
    <>
      <div className="bg-gray_51 flex flex-col font-markoone sm:gap-10 md:gap-10 gap-[100px] items-center justify-center mx-auto w-auto sm:w-full md:w-full">
                ...
                <div className="flex flex-1 md:flex-col flex-row md:gap-10 gap-[60px] items-center justify-start w-full">
                  <div className="flex flex-1 md:flex-col flex-row gap-8 items-start justify-start w-full">
                    <div className="flex flex-1 flex-col gap-2 items-start justify-start w-full">
                      <Text
                        className="font-bold text-gray_900 tracking-[-0.48px] w-full"
                        as="h5"
                        variant="h5"
                      >
                        Bruno Fernandes
                  ...
                  <Button className="bg-gray_900 cursor-pointer font-semibold min-w-[112px] sm:px-5 px-6 py-4 rounded-[10px] text-base text-center text-white_A700">
                    Contact
                  </Button>
                </div>
              </div>
              ...
              <div className="flex md:flex-col flex-row md:gap-10 gap-[65px] items-start justify-center w-full">
                <div className="flex flex-1 flex-col gap-[57px] items-start justify-start w-full">
                  <div className="flex flex-col gap-6 items-start justify-start w-full">
                    ...
                    <Text
                      className="font-normal leading-[180.00%] text-gray_600"
                      variant="body3"
                    >
                      <>
                  ...
                  <Button className="bg-gray_900 cursor-pointer font-semibold min-w-[525px] sm:min-w-full py-[13px] rounded-[10px] text-base text-center text-white_A700">
                    Contact
                  </Button>
                </div>
                <div className="flex flex-1 flex-col gap-6 items-start justify-start w-full">
                  <div className="flex flex-col gap-1 items-start justify-start w-full">
                    ...
                    <Text
                      className="font-semibold text-gray_600 w-full"
                      variant="body3"
                    >
                      15+ years experience
                    </Text>
                  ...
                  <div className="flex sm:flex-col flex-row sm:gap-10 gap-[60px] items-start justify-start w-full">
                    ...
                    <div className="flex flex-1 flex-col gap-1 items-start justify-start w-full">
                      ...
                      <Text
                        className="common-pointer font-semibold text-gray_600 underline w-full"
                        variant="body3"
              ...
              <div className="flex flex-col gap-10 items-start justify-start w-full">
                <div className="flex flex-col gap-[22px] items-center justify-start w-full">
                  <div className="flex sm:flex-col flex-row gap-5 items-center justify-between md:px-10 sm:px-5 px-[42px] w-full">
                    ...
                    <Button
                      className="bg-gray_900 cursor-pointer flex items-center justify-center min-w-[190px] px-4 py-5 rounded-[10px]"
                      rightIcon={
                        <Img
                ...
                <div className="flex flex-col gap-[25px] items-start justify-center sm:px-5 px-[25px] w-full">
                  ...
                  >
                    <div className="bg-white_A700 border border-bluegray_100 border-solid flex flex-1 flex-col items-start justify-start sm:px-5 px-[30px] py-[39px] rounded-[20px] w-full">
                      <div className="flex flex-col gap-10 items-start justify-start w-full">
                        <Text
                          className="font-semibold leading-[165.00%] max-w-[1090px] md:max-w-full text-gray_600"
                          as="h5"
                          variant="h5"
                        >
                        ...
                        <div className="flex flex-col gap-[25px] items-start justify-start w-full">
                          <div className="flex sm:flex-col flex-row gap-[50px] items-start justify-start md:pr-10 sm:pr-5 pr-[552px] w-full">
                            <div className="flex flex-1 flex-row gap-2.5 items-center justify-start w-full">
                              ...
                              <Text
                                className="flex-1 font-semibold text-gray_600 tracking-[-0.40px] w-auto"
                                variant="body1"
                              >
                                4.5 review
                              </Text>
