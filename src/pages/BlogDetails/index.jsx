...
const BlogDetailsPage = () => {
  ...
  const tableColumns = React.useMemo(() => {
    ...
    return [
      tableColumnHelper.accessor("fullname", {
        cell: (info) => (
          <Text
            className="flex-1 font-semibold text-gray_600"
            as="p"
            variant="body4"
          >
            {info?.getValue()}
        ...
        header: (info) => (
          <Text
            className="flex-1 min-w-[234px] text-gray_900"
            as="p"
            variant="body7"
          >
            Full Name
      ...
      tableColumnHelper.accessor("phonenumber", {
        ...
        header: (info) => (
          <Text
            className="flex-1 min-w-[214px] text-gray_900"
            as="p"
            variant="body7"
          >
            Phone Number
  ...
  return (
    <>
      <div className="bg-gray_51 flex flex-col font-markoone sm:gap-10 md:gap-10 gap-[111px] items-start justify-start mx-auto w-auto sm:w-full md:w-full">
            ...
            <div className="flex flex-col md:gap-10 gap-[84px] items-start justify-start w-full">
              ...
              <div className="flex flex-col gap-12 items-start justify-start w-full">
                <div className="flex flex-col gap-4 items-start justify-start w-full">
                  ...
                  <Text
                    className="font-normal text-gray_600 w-full"
                    variant="body3"
                  >
                    <>
                ...
                <div className="bg-white_A700 border border-bluegray_100 border-solid flex flex-col items-start justify-start p-[30px] sm:px-5 rounded-[10px] w-full">
                  <div className="flex flex-col gap-5 items-start justify-start w-full">
                    ...
                    <div className="flex flex-col gap-5 items-start justify-start w-full">
                      <Text
                        className="font-normal leading-[180.00%] max-w-[936px] md:max-w-full text-gray_600"
                        variant="body3"
                      >
                ...
                >
                  <div className="flex flex-1 flex-col gap-5 items-start justify-start my-0 w-full">
                    ...
                    <div className="flex flex-col gap-5 items-start justify-start w-full">
                      <Text
                        className="font-normal leading-[180.00%] max-w-[894px] md:max-w-full text-gray_600"
                        variant="body3"
                      >
                        Static websites are way faster than dynamic ones. As
                        they don’t have a back-end system, there is no time loss
              ...
              <div className="flex flex-col gap-6 items-start justify-start w-full">
                <div className="flex flex-col gap-4 items-start justify-start w-full">
                  ...
                  <Text
                    className="font-normal leading-[180.00%] max-w-[996px] md:max-w-full text-gray_600"
                    variant="body3"
                  >
              ...
              <div className="flex flex-col md:gap-10 gap-[60px] items-start justify-start w-full">
                ...
                <div className="flex flex-col gap-4 items-start justify-start w-full">
                  <div className="flex flex-row gap-[15px] items-center justify-start w-full">
                    <Text className="font-bold text-gray_600" variant="body3">
                      01.
                    </Text>
                    <Text
                      className="font-semibold text-gray_600 w-auto"
                ...
                <div className="flex flex-col items-center justify-between md:pr-10 sm:pr-5 pr-[568px] w-full">
                  <div className="flex sm:flex-col flex-row gap-6 items-center justify-start max-w-[836px] w-full">
                    ...
                    <div className="flex flex-col gap-2 items-start justify-start w-[165px]">
                      <Text
                        className="font-bold text-gray_900 tracking-[-0.48px] w-auto"
                        as="h5"
                        variant="h5"
                      >
                        Kristin Watson
