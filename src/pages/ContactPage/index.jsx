          ...
          <div className="flex flex-col font-manrope items-center justify-start md:px-10 sm:px-5 px-[120px] w-full">
            <div className="flex flex-col gap-11 items-center justify-start max-w-[1200px] mx-auto w-full">
              <div className="flex flex-col gap-4 items-center justify-start w-full">
                <Text
                  className="text-center text-gray_900 tracking-[-1.08px] w-full"
                  as="h1"
                  variant="h1"
                >
                  Get in touch
                ...
                <Text
                  className="font-normal leading-[180.00%] max-w-[1200px] md:max-w-full text-center text-gray_600"
                  variant="body3"
                >
                ...
                <div className="flex flex-1 flex-col gap-10 items-start justify-center w-full">
                  <div className="flex flex-col gap-4 items-start justify-start w-full">
                    <div className="flex flex-col gap-1 items-start justify-start w-full">
                      ...
                      <Text
                        className="font-semibold leading-[180.00%] text-gray_600"
                        variant="body3"
                      >
                        <>
                    ...
                    <div className="flex flex-col gap-2.5 items-start justify-start w-full">
                      <div className="flex flex-row gap-3 items-center justify-start w-full">
                        ...
                        />
                        <Text
                          className="flex-1 font-semibold text-gray_600 w-auto"
                          variant="body3"
                        >
                          (123) 456-7890
                        </Text>
