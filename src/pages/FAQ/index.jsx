...
const FAQPage = () => {
  ...
  return (
    <>
      <div className="bg-gray_51 flex flex-col font-markoone sm:gap-10 md:gap-10 gap-[68px] items-center justify-start mx-auto w-auto sm:w-full md:w-full">
        ...
        <div className="flex flex-col font-manrope items-center justify-center md:px-10 sm:px-5 px-[120px] w-full">
          <div className="flex flex-col gap-10 items-center justify-start max-w-[1200px] mx-auto w-full">
            <Text
              className="text-center text-gray_900 tracking-[-0.92px] w-full"
              as="h2"
              variant="h2"
            >
                ...
                <div className="flex flex-col gap-5 items-start justify-start w-full">
                  <div className="flex flex-col gap-4 items-start justify-start max-w-[732px] w-full">
                    ...
                    <div className="flex flex-col gap-2.5 items-start justify-start w-full">
                      <Text
                        className="common-pointer font-semibold text-gray_600 w-full"
                        variant="body4"
                      ...
                      <Text
                        className="leading-[150.00%] max-w-[732px] md:max-w-full text-gray_600"
                        variant="body5"
                      >
                  ...
                  >
                    <div className="flex flex-1 flex-col gap-4 items-start justify-start w-full">
                      ...
                      <div className="flex flex-col gap-2.5 items-start justify-start w-full">
                        ...
                        <Text className="text-gray_600 w-full" variant="body5">
                          Ipsum sunt incidunt veniam sint nemo et aut. Vero ut
                          quibusdam autem suscipit culpa perspiciatis.
                          Exercitationem dolorum dolore perferendis praesen…
                        </Text>
