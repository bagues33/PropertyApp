        ...
        <div className="bg-white_A700 border border-bluegray_100 border-solid flex flex-col items-start justify-start md:px-5 px-[30px] py-10 rounded-[10px] w-full">
          <div className="flex flex-col gap-8 items-center justify-center w-full">
            <div className="flex flex-col gap-4 items-start justify-start w-full">
              <div className="flex flex-col gap-6 items-start justify-start w-full">
                <div className="flex flex-row gap-2 items-center justify-start w-full">
                  <Text
                    className="flex-1 text-gray_900 tracking-[-0.72px] w-auto"
                    as="h3"
                    variant="h3"
                  >
                    Log in
            ...
            <div className="flex flex-col gap-[18px] items-start justify-start w-full">
              ...
              <Button
                className="common-pointer bg-white_A700 border border-gray_600 border-solid cursor-pointer flex items-center justify-center min-w-[420px] sm:min-w-full px-6 py-5 rounded-[10px]"
