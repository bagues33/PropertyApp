          ...
          <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start w-full">
            <div className="flex flex-col gap-[43px] items-start justify-start w-[341px]">
              <div className="flex flex-row gap-[11px] h-10 md:h-auto items-center justify-start w-[341px]">
                ...
                />
                <Text
                  className="font-markoone font-normal text-orange_A700 w-auto"
                  variant="body1"
                >
                  Relasto
                </Text>
              ...
              <div className="flex flex-col gap-7 h-[194px] md:h-auto items-start justify-start w-full">
                <Text
                  className="font-manrope font-semibold leading-[160.00%] text-gray_900"
                  variant="body4"
                >
                  <>
                ...
                <div className="flex flex-col gap-1 items-start justify-start w-auto">
                  <Text
                    className="font-manrope font-semibold text-gray_900 w-auto"
                    variant="body4"
                  >
                    +(123) 456-7890
                  </Text>
            ...
            <div className="flex flex-1 md:flex-col flex-row md:gap-10 gap-[77px] items-start justify-start w-full">
              <div className="flex flex-1 flex-col gap-5 items-start justify-start w-full">
                <Text
                  className="font-bold font-manrope text-gray_900 w-full"
                  variant="body3"
                >
                  Features
                </Text>
                <div className="flex flex-col gap-3.5 items-start justify-start w-full">
                  <Text
                    className="font-manrope font-semibold text-gray_900 w-full"
                    variant="body4"
                  >
                    Home v1
                  </Text>
