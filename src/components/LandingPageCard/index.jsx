    ...
    <>
      <div className={props.className}>
        <Img
          ...
          alt="image"
        />
        <div className="bg-gray_51 border border-red_101 border-solid flex flex-col items-start justify-start px-5 py-[30px] rounded-bl-[10px] rounded-br-[10px] w-full">
          <div className="flex flex-col gap-[27px] items-start justify-start w-full">
            <div className="flex flex-row gap-3 items-center justify-start w-full">
              <Img src="images/img_eye.svg" className="h-6 w-6" alt="eye" />
              <Text
                className="flex-1 font-manrope font-semibold text-gray_900 w-auto"
                variant="body4"
              >
            ...
            <div className="flex flex-col gap-[21px] items-start justify-start w-full">
              <div className="flex flex-row gap-10 items-center justify-between w-full">
                <div className="flex flex-1 flex-row gap-3 items-center justify-start w-full">
                  ...
                  />
                  <Text
                    className="flex-1 font-manrope font-semibold text-gray_700 w-auto"
                    variant="body4"
                  >
                    {props?.p3bedroom}
                  </Text>
                ...
                <div className="flex flex-1 flex-row gap-3 items-center justify-start w-full">
                  ...
                  />
                  <Text
                    className="font-manrope font-semibold text-gray_700 w-auto"
                    variant="body4"
                  >
                    {props?.bathcounter}
                  </Text>
            ...
            <div className="flex flex-row gap-[31px] items-center justify-start w-full">
              ...
              <Text
                className="flex-1 font-bold font-manrope text-gray_900 tracking-[-0.48px] w-auto"
                as="h5"
                variant="h5"
              >
                {props?.price}
